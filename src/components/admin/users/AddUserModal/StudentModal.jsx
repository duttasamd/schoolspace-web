        ...
        <div className="from-group-row" id="hidden_student_row">
            <div className="form-group row">
                ...
                <div className="col-md-6">
                    <select id="standard_id" type="text" name="standard_id" onChange={e => getSections(e.target.value)} onInput={props.changeHandle} required>
            ...
            <div className="form-group row" id="student_section_id">
                ...
                <div className="col-md-6">
                    <select id="student_section" type="text"  name="student_section" onChange={e => getRoll(e.target.value)} onInput={props.changeHandle} required>
            ...
            <div className="form-group row" id="roll_id">
                ...
                <div className="col-md-6">
                    <input id="roll" type="number" name="roll" placeholder={roll} onChange={props.changeHandle} required/>
                </div>
            </div>
        </div>
